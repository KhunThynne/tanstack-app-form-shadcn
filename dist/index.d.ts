...
export declare const createAppForm: (config?: Partial<createFormProps>) => {
    ...
    [x: string]: ComponentType<any>;
    }, Record<string, ComponentType<any>>, TRenderProps>) => FunctionComponent<PropsWithChildren<NoInfer<[unknown] extends [TRenderProps] ? any : TRenderProps> & {
    ...
    [x: string]: ComponentType<any>;
    }, Record<string, ComponentType<any>>> | AppFieldExtendedReactFieldGroupApi<unknown, TFormData, string | FieldsMap<unknown, TFormData>, any, any, any, any, any, any, any, any, any, any, unknown extends TSubmitMeta ? TFormSubmitMeta : TSubmitMeta, {
    [x: string]: ComponentType<any>;
    }, Record<string, ComponentType<any>>>;
    fields: TFields;
