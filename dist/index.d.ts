...
export declare const createAppForm: (config?: Partial<createFormProps>) => {
    ...
    withForm: <TFormData, TOnMount extends FormValidateOrFn<TFormData> | undefined, TOnChange extends FormValidateOrFn<TFormData> | undefined, TOnChangeAsync extends FormAsyncValidateOrFn<TFormData> | undefined, TOnBlur extends FormValidateOrFn<TFormData> | undefined, TOnBlurAsync extends FormAsyncValidateOrFn<TFormData> | undefined, TOnSubmit extends FormValidateOrFn<TFormData> | undefined, TOnSubmitAsync extends FormAsyncValidateOrFn<TFormData> | undefined, TOnDynamic extends FormValidateOrFn<TFormData> | undefined, TOnDynamicAsync extends FormAsyncValidateOrFn<TFormData> | undefined, TOnServer extends FormAsyncValidateOrFn<TFormData> | undefined, TSubmitMeta, TRenderProps extends object = {}>({ render, props, }: WithFormProps<TFormData, TOnMount, TOnChange, TOnChangeAsync, TOnBlur, TOnBlurAsync, TOnSubmit, TOnSubmitAsync, TOnDynamic, TOnDynamicAsync, TOnServer, TSubmitMeta, Record<string, ComponentType<any>> | {
    readonly Input: LazyComp;
    readonly Select: LazyComp;
    readonly TextArea: LazyComp;
    readonly CheckBox: LazyComp;
    ...
    withFieldGroup: <TFieldGroupData, TSubmitMeta, TRenderProps extends object = {}>({ render, props, defaultValues, }: WithFieldGroupProps<TFieldGroupData, Record<string, ComponentType<any>> | {
    readonly Input: LazyComp;
    readonly Select: LazyComp;
    readonly TextArea: LazyComp;
    readonly CheckBox: LazyComp;
    ...
    form: AppFieldExtendedReactFormApi<TFormData, TOnMount, TOnChange, TOnChangeAsync, TOnBlur, TOnBlurAsync, TOnSubmit, TOnSubmitAsync, TOnDynamic, TOnDynamicAsync, TOnServer, unknown extends TSubmitMeta ? TFormSubmitMeta : TSubmitMeta, Record<string, ComponentType<any>> | {
    readonly Input: LazyComp;
    readonly Select: LazyComp;
    readonly TextArea: LazyComp;
    readonly CheckBox: LazyComp;
    ...
    readonly SubscribeButton: typeof SubscribeButton;
    }> | AppFieldExtendedReactFieldGroupApi<unknown, TFormData, string | FieldsMap<unknown, TFormData>, any, any, any, any, any, any, any, any, any, any, unknown extends TSubmitMeta ? TFormSubmitMeta : TSubmitMeta, Record<string, ComponentType<any>> | {
    readonly Input: LazyComp;
    readonly Select: LazyComp;
    readonly TextArea: LazyComp;
    readonly CheckBox: LazyComp;
...
export declare type createFormProps = Parameters<typeof createFormHook>[0];
